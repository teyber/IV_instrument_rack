...
def get_cDAQ_16ch(time_acquire):
...
# #DELETE THIS AFTER DEBUG
	# plot_colors = plt.cm.jet(np.linspace(0.1, 0.9, 8))
	# x_vec = np.arange(np.size(mod3_ai0))

	# fig = plt.figure(figsize=(8,6))
	# ax = plt.subplot(1,1,1)

	# ax.plot(x_vec, 1000*mod3_ai0, color=plot_colors[0], label = 'Vhall_A1')
	# ax.plot(x_vec, 1000*mod3_ai1, color=plot_colors[1], label = 'Vhall_A3')
	# ax.plot(x_vec, 1000*mod3_ai2, color=plot_colors[2], label = 'Vhall_A5')
	# ax.plot(x_vec, 1000*mod3_ai3, color=plot_colors[3], label = 'Vhall_A7')

	# ax.plot(x_vec, 1000*mod4_ai0, color=plot_colors[4], label = 'Vhall_B1')
	# ax.plot(x_vec, 1000*mod4_ai1, color=plot_colors[5], label = 'Vhall_B3')
	# ax.plot(x_vec, 1000*mod4_ai2, color=plot_colors[6], label = 'Vhall_B5')
	# ax.plot(x_vec, 1000*mod4_ai3, color=plot_colors[7], label = 'Vhall_B7')
